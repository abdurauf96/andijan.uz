        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header"> <h4> Question {{ $question->id }} </h4>
                        <div class="card-header-form">
                          ...
                          <form method="POST" action="{{ url('admin/questions' . '/' . $question->id) }}" accept-charset="UTF-8" style="display:inline">
                              @method('DELETE')
                              @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table table">
                                <tbody>
                                    ...
                                    <tr><th> Title Uz </th><td> {{ $question->title_uz }} </td></tr><tr><th> Title Ru </th><td> {{ $question->title_ru }} </td></tr><tr><th> Title En </th><td> {{ $question->title_en }} </td></tr>
                                </tbody>
                            </table>
                        </div>
