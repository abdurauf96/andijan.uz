<div class="form-group{{ $errors->has('title_uz') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="title_uz" type="text" id="title_uz" value="{{ $holiday->title_uz ?? ''}}" required>

    {!! $errors->first('title_uz', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('title_ru') ? 'has-error' : ''}}">
    <label for="title_ru" class="control-label">{{ 'Title Ru' }}</label>
    <input class="form-control" name="title_ru" type="text" id="title_ru" value="{{ $holiday->title_ru ?? ''}}" >

    {!! $errors->first('title_ru', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('title_en') ? 'has-error' : ''}}">
    <label for="title_en" class="control-label">{{ 'Title En' }}</label>
    <input class="form-control" name="title_en" type="text" id="title_en" value="{{ $holiday->title_en ?? ''}}" >

    {!! $errors->first('title_en', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('body_uz') ? 'has-error' : ''}}">
    <label for="body_uz" class="control-label">{{ 'Body Uz' }}</label>
    <textarea class="form-control" rows="5" name="body_uz" type="textarea" id="body_uz" >{{ $holiday->body_uz ?? ''}}</textarea>
...
<div class="form-group{{ $errors->has('body_ru') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="body_ru" type="textarea" id="body_ru" >{{ $holiday->body_ru ?? ''}}</textarea>
...
<div class="form-group{{ $errors->has('body_en') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="body_en" type="textarea" id="body_en" >{{ $holiday->body_en ?? ''}}</textarea>
