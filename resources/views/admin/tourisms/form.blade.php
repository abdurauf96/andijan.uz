<div class="form-group{{ $errors->has('title_uz') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="title_uz" type="text" id="title_uz" value="{{ $tourism->title_uz ?? ''}}" required>

    {!! $errors->first('title_uz', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('title_ru') ? 'has-error' : ''}}">
    <label for="title_ru" class="control-label">{{ 'Title Ru' }}</label>
    <input class="form-control" name="title_ru" type="text" id="title_ru" value="{{ $tourism->title_ru ?? ''}}" >

    {!! $errors->first('title_ru', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('title_en') ? 'has-error' : ''}}">
    <label for="title_en" class="control-label">{{ 'Title En' }}</label>
    <input class="form-control" name="title_en" type="text" id="title_en" value="{{ $tourism->title_en ?? ''}}" >

    {!! $errors->first('title_en', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('title_en') ? 'has-error' : ''}}">
    <label for="title_en" class="control-label">{{ 'Title kr' }}</label>
    <input class="form-control" name="title_kr" type="text" id="title_en" value="{{ $tourism->title_kr ?? ''}}" >
...
<div class="form-group{{ $errors->has('body_uz') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="body_uz" type="textarea" id="body_uz" >{{ $tourism->body_uz ?? ''}}</textarea>
...
<div class="form-group{{ $errors->has('body_ru') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="body_ru" type="textarea" id="body_ru" >{{ $tourism->body_ru ?? ''}}</textarea>
...
<div class="form-group{{ $errors->has('body_en') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="body_en" type="textarea" id="body_en" >{{ $tourism->body_en ?? ''}}</textarea>

    {!! $errors->first('body_en', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('body_en') ? 'has-error' : ''}}">
    <label for="body_en" class="control-label">{{ 'Body kr' }}</label>
    <textarea class="form-control" rows="5" name="body_kr" type="textarea" id="body_en" >{{ $tourism->body_kr ?? ''}}</textarea>
...
<div class="form-group{{ $errors->has('image') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="image" type="file" id="image" value="{{ $tourism->image ?? ''}}" >
