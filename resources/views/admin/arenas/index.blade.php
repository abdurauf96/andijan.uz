                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-header-form">
                            <a href="{{ url('/admin/arenas/create') }}" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i>Add new</a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                @foreach($arenas as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/admin/arenas' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                @method('DELETE')
                                                @csrf
                                                <button type="submit" class="btn btn-danger btn-icon" title="Delete Arena" onclick="return confirm(&quot;Confirm delete?&quot;)"><i class="fas fa-trash-alt" aria-hidden="true"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
                            ...
                            <div class="pagination-wrapper"> {{ $arenas->links() }} </div>
                        </div>
