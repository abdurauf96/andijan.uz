            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4> Edit University #{{ $university->id }} </h4>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/universities/' . $university->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            @include ('admin.universities.form', ['formMode' => 'edit'])
