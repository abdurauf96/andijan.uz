            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/symbols/' . $symbol->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            @include ('admin.symbols.form', ['formMode' => 'edit'])
...
@section('js')
    ...
    <script type="text/javascript">
        CKEDITOR.replace( 'body_uz',{
            filebrowserUploadUrl: "{{route('admin.symbolsImageUpload', ['_token' => csrf_token() ])}}",
