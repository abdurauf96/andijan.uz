            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ url('/admin/partners') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
...
@section('js')
    ...
    <script type="text/javascript">
        CKEDITOR.replace( 'body_uz', {
            filebrowserUploadUrl: "{{route('admin.partnerImageUpload', ['_token' => csrf_token() ])}}",
