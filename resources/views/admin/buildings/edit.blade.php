            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4> Edit Building #{{ $building->id }} </h4>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/buildings/' . $building->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            @include ('admin.buildings.form', ['formMode' => 'edit'])
